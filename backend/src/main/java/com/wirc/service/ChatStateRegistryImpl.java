...
@Service
public class ChatStateRegistryImpl implements ChatStateRegistry {

    private final Map<String, RoomSession> rooms = new ConcurrentHashMap<>();
    private final MessageValidationHandler validationChain;

    public ChatStateRegistryImpl(ChatRoomFactory roomFactory, DatabaseChatRoomLoader databaseChatRoomLoader) {
